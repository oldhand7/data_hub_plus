          ...
          <div className="h-16 w-full gap-0 sm:gap-3 flex items-center justify-between">
            <div className="3xl:flex-1 flex flex-row ">
              ...
              <div className="3xl:flex-1 flex align-center">
                <NextLink
                  ...
                  <span className="sr-only 3xl:not-sr-only">DataHub</span>
                </NextLink>
              </div>
            </div>
            ...
            <div className="text-base justify-center items-center gap-1.5 flex 3xl:flex-1 flex-row 3xl:justify-end">
              <div className="mx-2.5 gap-1.5 hidden lg:flex">
                <NavItem isActive={section === 'python'} url="/python">
                  Python
                </NavItem>
                <NavItem isActive={section === 'sql'} url="/sql">
                  SQL
                </NavItem>
                <NavItem isActive={section === 'reference'} url="/r">
                  R
                </NavItem>
