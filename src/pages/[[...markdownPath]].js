...
import sidebarR from '../sidebarR.json';
import sidebarSql from '../sidebarSql.json';
...
export default function Layout({content, toc, meta}) {
  ...
  switch (section) {
    ...
    case 'unknown':
      ...
      break;
    case 'python':
      routeTree = sidebarPython;
      break;
    case 'r':
      routeTree = sidebarR;
      break;
    case 'sql':
      routeTree = sidebarSql;
      break;
    case 'learn':
...
function useActiveSection() {
  ...
  if (cleanedPath === '/') {
    return 'home';
  } else if (asPath.startsWith('/sql')) {
    return 'sql';
  } else if (asPath.startsWith('/r')) {
    return 'r';
  } else if (asPath.startsWith('/python')) {
    return 'python';
